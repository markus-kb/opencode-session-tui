...
## Installation
```bash
# Clone this fork and install deps
...
If your change is general enough to benefit the upstream project, consider opening a PR at [shuv1337/oc-manager](https://github.com/shuv1337/oc-manager) as well.
